...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      store: path.join(path.resolve(__dirname, '..'), 'src/redux/store'),
      view: path.join(path.resolve(__dirname, '..'), 'src/view'),
      components: path.join(path.resolve(__dirname, '..'), 'src/components'),
      router: path.join(path.resolve(__dirname, '..'), 'src/router'),
      actions: path.join(path.resolve(__dirname, '..'), 'src/redux/actions'),
      reducers: path.join(path.resolve(__dirname, '..'), 'src/redux/reducers'),
    },
    plugins: [
